<?php
    ...
    try {
        ...
        echo "<div class='text-center' style='color: green'>Empresa desativada com sucesso.</div>";

        header("Location: ../../views/empresa/empresa-index.php");

    } catch (\Exception $e) {
        echo "<div class='text-center' style='color: red'>Não foi possível desativar a empresa. Verifique seus dados e tente novamente.</div>";
    }
